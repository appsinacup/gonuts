...
public:
	...
	void clear();
	void start();
	void start_with_shell(const String &shell_path);
	void stop();
	...
	virtual Vector2 get_minimum_size() const override;
...
private:
	...
	bool _is_select_all_request(Key code);
	...
	void _on_context_menu_item_selected(int p_id);
